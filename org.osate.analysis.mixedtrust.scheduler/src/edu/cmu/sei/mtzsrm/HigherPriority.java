...
public class HigherPriority implements Iterator<MixedTrustTask> {
	...
	public HigherPriority(TreeSet<MixedTrustTask> set, MixedTrustTask t){
		this.set = set;
		this.t= t;
	...
	public static void main(String args[])
	{
		...
		HigherPriority iter = new HigherPriority(set, mt3);
