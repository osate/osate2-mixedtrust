...
public class LowerPriorityHigherGuestCriticality implements Iterator<MixedTrustTask> {
	...
	public LowerPriorityHigherGuestCriticality(TreeSet<MixedTrustTask> set, MixedTrustTask ti){
		this.ti = ti;
	...
	public static void main(String args[]){
		...
		LowerPriorityHigherGuestCriticality lphc = new LowerPriorityHigherGuestCriticality(set,mt2);
